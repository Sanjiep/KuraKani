                ...
                <div className="mt-5">
                  ...
                  <form>
                    <div className="grid gap-y-4">
                      <div>
                        <label htmlFor="email" className="block text-sm mb-2 dark:text-cream">Email address</label>
                        <div className="relative">
                          <input type="email" placeholder='name@example.com' id="email" name="email" className="py-3 px-4 block w-full border-1 border-default bg-transparent rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" required aria-describedby="email-error" />
                      ...
                      <div>
                        <div className="flex justify-between items-center">
                          <label htmlFor="password" className="block text-sm mb-2 dark:text-cream">Confirm Password</label>
                        </div>
                        <div className="relative flex items-center">
                          <input id="password" placeholder='Confirm Password' name="password" type={isVisible ? 'text' : 'password'} className="py-3 px-4 block w-full border-default border-1 bg-transparent rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" required aria-describedby="password-error" />
                          <button className="focus:outline-none absolute right-4" type="button" onClick={toggleVisibility}>
                            {isVisible ? (
                              <svg className="text-2xl opacity-80 text-default-400 pointer-events-none" width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="Edit / Show">
