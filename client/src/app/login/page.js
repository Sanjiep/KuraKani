...
function login() {
    ...
    return (
        <div className="h-full bg-gray-600">
            <div className="dark:bg-slate-900 bg-cream flex h-full items-center py-5">
                    ...
                    <div className="p-4 sm:p-5">
                        <div className="text-center">
                            ...
                            <p className="mt-2 text-sm text-gray-800 dark:text-gray-400">
                                ...
                                <a className="text-hunyellow hover:text-yellow-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-800" href="/signup"> Sign up here
                                </a>
                            </p>
                        </div>
                                ...
                                <div className="grid gap-y-4">
                                    <div>
                                        ...
                                        <div className="relative">
                                            <input type="email" placeholder='Email or Username' id="email" name="email" className="py-3 px-4 block w-full border-1 border-default bg-transparent rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" required aria-describedby="email-error" />
