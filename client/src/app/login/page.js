                        ...
                        <div className="p-4 sm:p-7">
                            <div className="flex flex-col text-center items-center">
                                ...
                                <p className="mt-2 text-sm text-gray-800 dark:text-gray-400">
                                    ...
                                    <a className="text-hunyellow hover:text-yellow-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-800" href="/signup"> Create account
                                    </a>
                                </p>
                            </div>

                            <div className="mt-5">
                                <button type="button" className="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-default text-default shadow-sm hover:bg-default hover:text-cream disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-cream dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                                ...
                                <div className="grid gap-y-4">
                                    <div>
                                        <label htmlFor="email" className="block text-sm mb-2 dark:text-cream">Email address or Username</label>
                                        <div className="relative">
                                            <input type="email" onChange={formik.handleChange} onBlur={formik.handleBlur}
                                                value={formik.values.email}
                                                label='email' placeholder='Email or Username' id="email" name="email" className="py-3 px-4 block w-full border-1 border-default bg-transparent rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" required aria-describedby="email-error" />
                                    ...
                                    <div>
                                        ...
                                        <div className="relative flex items-center">
                                            <input onBlur={formik.handleBlur}
                                                ...
                                                value={formik.values.password} label="password" id="password" placeholder='Password' name="password" type={isVisible ? 'text' : 'password'} className="py-3 px-4 block w-full border-default border-1 bg-transparent rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" required aria-describedby="password-error" />
                                    ...
                                    <div className="flex items-center">
                                        <div className="flex">
                                            <Checkbox color="warning" radius="sm">Remember me</Checkbox>
                                        </div>
                                        {/* <div className="ms-3">
                                            <label htmlFor="remember-me" className="text-sm dark:text-cream">Remember me</label>
                                        </div> */}
                                    </div>
