        ...
        <div>
            <div className="flex flex-col justify-center items-center mx-auto h-screen xl:px-0 dark:bg-gray-900">
                ...
                <div className="text-center xl:max-w-4xl">
                    ...
                    <a href='/' className="text-cream bg-default hover:bg-gray-900 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-3 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
